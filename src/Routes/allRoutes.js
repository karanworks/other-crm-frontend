...
import UiLinks from "../pages/BaseUi/UiLinks/UiLinks";
...
import RangeAreaCharts from "../pages/Charts/ApexCharts/RangeAreaCharts/index";
...
const authProtectedRoutes = [
  ...
  { path: "/charts-apex-range-area", component: <RangeAreaCharts /> },
